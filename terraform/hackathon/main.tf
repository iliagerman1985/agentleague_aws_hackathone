terraform {
  ...
  backend "s3" {
    bucket  = "agentleague-hackathon-tf-state"
...
# NOTE: PostgreSQL security group moved to rds.tf (Aurora Serverless v2)
...
# ============================================================================
# APPLICATION LOAD BALANCER (BACKEND ONLY)
# ============================================================================
...
# ============================================================================
# NOTE: EFS removed - Aurora Serverless v2 RDS handles data persistence
# See rds.tf for database configuration
# ============================================================================
